...
SECRET_KEY = 'django-insecure-jb&nhw+j*9po=_zm_f#6gg*5=dcdvp@kr(bnr!cr@v4s3i6bm8'
...
ALLOWED_HOSTS = ['*']
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'finance-app-frontend', 'build', 'static'),
]
...
STATICFILES_DIRS.append(os.path.join(
    BASE_DIR, 'finance-app-frontend', 'build'))
